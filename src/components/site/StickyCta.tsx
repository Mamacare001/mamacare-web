...
export function StickyCta() {
  ...
  if (["/login", "/dashboard", "/app", "/family", "/chw", "/supervisor", "/clinic", "/insights", "/care", "/portal", "/offline", "/emergency", "/verify", "/forgot", "/reset", "/onboarding", "/invite"].some((r) => pathname.startsWith(r))) return null;
