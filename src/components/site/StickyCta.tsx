...
export function StickyCta() {
  ...
  if (["/login", "/dashboard", "/app", "/family", "/chw", "/supervisor", "/clinic", "/insights", "/care", "/portal", "/admin", "/notifications", "/help", "/switch-role", "/status", "/offline", "/emergency", "/verify", "/forgot", "/reset", "/onboarding", "/invite"].some((r) => pathname.startsWith(r))) return null;
